...
2)  Click the terminal icon <img src="../_static/media/chapter_7\section_1/media/image1.png"  style="width:30px"   class="common_img"/> in the system desktop to open a ROS2 command-line window.
...
7)  After closing the LAB Tool, you need to restart the APP auto-start service by entering the corresponding command in the black terminal<img src="../_static/media/chapter_7\section_1/media/image7.png"  style="width:30px"   class="common_img"/>. Once the service starts, the robot arm will return to its initial position.
...
> [!NOTE]
>
> **For how to adjust the color threshold, please scroll up to [7.1.3 Adjusting Color Threshold]() in this document.**
...
First, capture the RGB image from the camera, then resize and apply Gaussian blur to the image, and convert the color space from RGB to Lab. For more details on the Lab color space, please refer to [OpenCV Computer Vision Course]().
...
2)  Click the terminal icon <img src="../_static/media/chapter_7\section_1/media/image1.png"  style="width:30px"   class="common_img"/> in the system desktop to open a command-line window.
...
6. The program will launch the camera image interface. For details on the detection steps, please refer to the section [7.2.3 Program Outcome]() in this document.
...
[/home/ubuntu/ros2_ws/src/example/example/color_detect/color_detect_demo.py](/home/ubuntu/ros2_ws/src/example/example/color_detect/color_detect_demo.py)
...
[/home/ubuntu/ros2_ws/src/example/example/qrcode/qrcode_creater.py](/home/ubuntu/ros2_ws/src/example/example/qrcode/qrcode_creater.py)
...
[/home/ubuntu/ros2_ws/src/example/example/qrcode/qrcode_detecter.py](/home/ubuntu/ros2_ws/src/example/example/qrcode/qrcode_detecter.py)
...
2)  Click the terminal icon <img src="../_static/media/chapter_7\section_1/media/image52.png"  style="width:30px"   class="common_img"/> in the system desktop to open a ROS2 command-line window.
...
Firstly, the program will acquire the RGB image of the camera, scale the image, and perform Gaussian filtering on the image to convert the image color space from RGB into LAB. For more details on the Lab color space, please refer to [OpenCV Computer Vision Course]().
...
[/home/ubuntu/ros2_ws/src/app/launch/line_following_node.launch.py](/home/ubuntu/ros2_ws/src/app/launch/line_following_node.launch.py)
...
[/home/ubuntu/ros2_ws/src/app/app/line_following.py](/home/ubuntu/ros2_ws/src/app/app/line_following.py)
...
<img src="../_static/media/chapter_7\section_1/media/image75.png"  style="width:500px"   class="common_img"/>
...
<img src="../_static/media/chapter_7\section_1/media/image76.png"  style="width:500px"   class="common_img"/>

Sets the line-following color and ROI list.

`get_area_max_contour`:

<img src="../_static/media/chapter_7\section_1/media/image77.png"  style="width:500px"   class="common_img"/>

Gets the contour with the largest area.

`Call`:

<img src="../_static/media/chapter_7\section_1/media/image78.png"  style="width:500px"   class="common_img"/>

Performs color recognition based on the set color and provides feedback on the recognized image and angle.

`LineFollowingNode`:

<img src="../_static/media/chapter_7\section_1/media/image79.png"  style="width:500px"   class="common_img"/>
...
<img src="../_static/media/chapter_7\section_1/media/image80.png"  style="width:500px"   class="common_img"/>

Sets the current node state.

`main`:

<img src="../_static/media/chapter_7\section_1/media/image81.png"  style="width:500px"   class="common_img"/>

Reads the image and uses the mouse for color selection.

`mouse_callback`:

<img src="../_static/media/chapter_7\section_1/media/image82.png"  style="width:500px"   class="common_img"/>

Mouse color selection callback function to obtain the pixel coordinates of the current mouse position.

`enter_srv_callback`:

<img src="../_static/media/chapter_7\section_1/media/image83.png"  style="width:500px"   class="common_img"/>

Service for entering autonomous line-following reads camera and Lidar data and initializes actions.

`exit_srv_callback`:

<img src="../_static/media/chapter_7\section_1/media/image84.png"  style="width:500px"   class="common_img"/>
...
<img src="../_static/media/chapter_7\section_1/media/image85.png"  style="width:500px"   class="common_img"/>

Service to set the target line-following color.

`get_target_color_srv_callback`:

<img src="../_static/media/chapter_7\section_1/media/image86.png"  style="width:500px"   class="common_img"/>

Service to get the target line-following color.

`set_running_srv_callback`:

<img src="../_static/media/chapter_7\section_1/media/image87.png"  style="width:500px"   class="common_img"/>

Service to start the autonomous patrolling mode.

`set_threshold_srv_callback`:

<img src="../_static/media/chapter_7\section_1/media/image88.png"  style="width:500px"   class="common_img"/>

Service to set the color threshold.

`lidar_callback`:

<img src="../_static/media/chapter_7\section_1/media/image89.png"  style="width:500px"   class="common_img"/>

Lidar callback function processes the received data and determines whether to stop moving.

`image_callback`:

<img src="../_static/media/chapter_7\section_1/media/image90.png"  style="width:500px"   class="common_img"/>
